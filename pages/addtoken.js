    ...
    <div>
      ...
      <div className='flex justify-center items-center'>
        <div className='flex justify-between items-center w-80 md:w-4/12 2xl:w-1/4 max-w-2xl md:mr-10'>
          <div className='flex justify-start items-center text-lg ml-6 sm:ml-0 2xl:ml-24'>
            {/* Inputs */}
              ...
              <div className='flex flex-col text-white font-bold mt-6'>
                <div className='flex flex-col'>
                  ...
                  <input
                    ...
                    className='bg-white rounded py-1 px-0 sm:px-3 md:px-20 2xl:px-28 border-2 focus:outline-none focus:border-transparent'
                  />
                </div>
